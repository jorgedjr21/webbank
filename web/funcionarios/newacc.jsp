                ...
                <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                        <div class="alert alert-warning text-center">
                            ...
                            <p>Os correntista 3 <strong>não terá a ordem trocada</strong> caso o correntista 2 não seja cadastrado!</p>
                        </div>
                    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="focusedInput" name="endereco1" type="text" placeholder="Endereço do Correntista">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label" for="focusedInput">Endereço</label>
                                            <input class="form-control" id="focusedInput" name="endereco2" type="text" placeholder="Endereço do Correntista">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label" for="focusedInput">Endereço</label>
                                            <input class="form-control" id="focusedInput" name="endereco3" type="text" placeholder="Endereço do Correntista">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
